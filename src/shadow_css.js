...
var /** @type {?} */ _commentWithHashRe = /\/\*#[\s\S]+?\*\//g;
/**
 * @param {?} input
 * @return {?}
 */
...
var /** @type {?} */ _sourceUrlRe = /\/\*#\s*sourceURL=[\s\S]+?\*\//;
/**
 * @param {?} hashComments
 * @return {?}
 */
function containsSourceUrl(hashComments) {
    return hashComments.reduce(function (result, comment) { return result || _sourceUrlRe.test(comment); }, false);
}
